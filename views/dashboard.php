...
<head>
    ...
    <style>
        ...
        body {
            background-color: #f8f9fa; /* Latar belakang netral */
        }
                    ...
                    <div class="card card-feature text-center">
                        ...
                        <div class="card-body p-4">
                            <div>
                                ...
                                <p class="card-text mb-4">Catat dan analisis semua pengeluaran Anda untuk kontrol anggaran yang lebih baik.</p>
                            </div>
                            <a href="expense/listExpense.php" class="btn btn-primary-custom w-100">Kelola Pengeluaran</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-feature text-center">
                        ...
                        <div class="card-body p-4">
                           <div>
                                ...
                                <p class="card-text mb-4">Monitor semua sumber pemasukan untuk mendapatkan gambaran finansial yang lengkap.</p>
                           </div>
                    ...
                    <div class="card card-feature text-center">
                        ...
                        <div class="card-body p-4">
                            <div>
                                ...
                                <p class="card-text mb-4">Buat dan kelola kategori transaksi untuk pelacakan yang lebih terperinci.</p>
                            </div>
                            <a href="../views/transaction/transactionHistory.php" class="btn btn-primary-custom w-100">Kelola Kategori</a>
                        </div>
                    </div>
                </div>
            </div>
