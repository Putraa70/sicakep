...
<head>
    ...
    <style>
        ...
        html, body {
            height: 100%;  /* Mengatur tinggi body dan html agar memenuhi layar */
            margin: 0;     /* Menghilangkan margin default */
        }

        body {
            display: flex;
            flex-direction: column; /* Menyusun elemen-elemen halaman secara vertikal */
        }

        main {
            flex-grow: 1;  /* Konten utama mengisi ruang yang tersedia */
            overflow-y: auto; /* Membuat konten dapat di-scroll */
        }
