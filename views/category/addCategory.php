...
require_once '../../controllers/categoryController.php'; // Pastikan kategoriController disertakan untuk mendapatkan kategori
...
$categories = getCategories(); // Panggil fungsi untuk mendapatkan kategori
?>
...
<div class="container mt-5">
    <h2 class="text-center">Tambah Pengeluaran</h2>
    <?php if ($error): ?>
